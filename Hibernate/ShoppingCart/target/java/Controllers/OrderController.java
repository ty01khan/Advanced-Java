...
public class OrderController
{
    ...
    @RequestMapping(value = { "/{userId}/getOrders" }, method = { RequestMethod.GET }, produces = { "application/json" })
    public ResponseEntity<List<Order>> getOrders(@PathVariable("userId") final int uid) {
        ...
        return (ResponseEntity<List<Order>>)new ResponseEntity((Object)orders, HttpStatus.OK);
    }
    
    @RequestMapping(value = { "/{userId}/createOrder" }, method = { RequestMethod.GET }, produces = { "application/json" })
    public ResponseEntity<Order> createOrders(@PathVariable("userId") final int uid) {
        ...
        return (ResponseEntity<Order>)new ResponseEntity((Object)order, HttpStatus.OK);
    }
}
